...
app.label_1 = customtkinter.CTkLabel(master=app.frame_left,
                                     text="CustomTkinter")  # font name and size in px
...
def newWindow():
    ...
    muscleGroup = customtkinter.CTkEntry(enterWindow, placeholder_text='Muscle Group', corner_radius=6, height=50,
                                         width=150)
    muscleGroup.place(x=130, y=150)

    muscleExercise = customtkinter.CTkEntry(enterWindow, placeholder_text='Exercise&Reps', corner_radius=6, height=50,
                                            width=150)
